...
SearchIconCreator.prototype.getIcon = function () {
  var classification = this.poiData.poi ? this.poiData.poi.classifications[0].code : undefined
  ...
  if (classification) {
    ...
    if (Array.isArray(classification)) {
      var iconName = classification.indexOf('hospital/polyclinic') > -1 ? 'HOSPITAL_POLYCLINIC' : classification.length > 1 ? classification[1].toUpperCase() : classification[0].toUpperCase()
...
module.exports = SearchIconCreator
